...
2. Encode lw (2 bytes, offset(base) addressing).
3. Encode sb (2 bytes, offset(base) addressing).
4. Encode sw (2 bytes, offset(base) addressing).
5. Parse the offset(base) operand format.
